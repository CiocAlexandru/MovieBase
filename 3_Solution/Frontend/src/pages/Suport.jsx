  ...
  return (
    <div className="pt-32 pb-20 px-6 md:px-20 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-20">
        ...
        <div className="bg-slate-900/20 border border-slate-800 p-8 md:p-12 rounded-[32px] shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
        ...
        <div className="lg:col-span-2 h-[400px] rounded-[32px] overflow-hidden border border-slate-800 shadow-2xl">
          <iframe
        ...
        <div className="bg-slate-900/40 border border-slate-800 p-10 rounded-[32px] h-full flex flex-col justify-center">
          <h3 className="text-xl font-black text-white mb-6 uppercase italic">Urmărește-ne</h3>
          <div className="space-y-4">
            <a href="https://facebook.com/peliculamedia" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-400 hover:text-indigo-500 transition-colors group">
            ...
            <a href="https://instagram.com/peliculamedia" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-400 hover:text-indigo-500 transition-colors group">
              <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-indigo-500/20">
                <span className="font-bold">IG</span>
              </div>
              <span className="font-bold uppercase tracking-wider text-sm">Instagram</span>
            </a>
            <a href="https://www.youtube.com/@peliculamedia9930" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-400 hover:text-indigo-500 transition-colors group">
              <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-indigo-500/20">
                <span className="font-bold">YT</span>
              </div>
              <span className="font-bold uppercase tracking-wider text-sm">YouTube</span>
            </a>
            <a href="https://tiktok.com/@peliculamedia" target="_blank" rel="noreferrer" className="flex items-center gap-4 text-slate-400 hover:text-indigo-500 transition-colors group">
              <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-indigo-500/20">
